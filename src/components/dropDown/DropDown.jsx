...
export default function DropDown({actualSort, setActualSort, tasks}) {
    ...
    const sortList = {
        fromimportant: { text: 'Приортету', icon: 'fromimportant' },
        ofimportance: { text: 'Приортету', icon: 'ofimportance' },
        ...
        <div className={styles.layout}>
            ...
            <div className={`${styles.menu} ${menuStyle=='open' ? styles.open : ''}`}>
                ...
                <div className={styles.content}>
                    <div className={`${styles.item} ${actualSort=='fromimportant' ? styles.active : ''}`} onClick={() => changeActualSort("fromimportant")} tabIndex={1}>
                        <Icon name="fromimportant" className={styles.itemicon}/>
                        <p>Приортету</p>
                        <Icon name="check" className={styles.checkicon} />
                    </div>
                    <div className={`${styles.item} ${actualSort=='ofimportance' ? styles.active : ''}`} onClick={() => changeActualSort("ofimportance")} tabIndex={1}>
                        <Icon name="ofimportance" className={styles.itemicon}/>
                        <p>Приортету</p>
                        <Icon name="check" className={styles.checkicon} />
                    </div>
                    <div className={`${styles.item} ${actualSort=='atoz' ? styles.active : ''}`} onClick={() => changeActualSort("atoz")} tabIndex={1}>
                        <Icon name="atoz" className={styles.itemicon}/>
                        <p>Алфавиту</p>
                        <Icon name="check" className={styles.checkicon} />
                    </div>
                    <div className={`${styles.item} ${actualSort=='ztoa' ? styles.active : ''}`} onClick={() => changeActualSort("ztoa")} tabIndex={1}>
                        <Icon name="ztoa" className={styles.itemicon}/>
                        <p>Алфавиту</p>
                        <Icon name="check" className={styles.checkicon} />
                    </div>
                    <div className={`${styles.item} ${actualSort=='dateto' ? styles.active : ''}`} onClick={() => changeActualSort("dateto")} tabIndex={1}>
                        <Icon name="dateto" className={styles.itemicon}/>
                        <p>Дате создания</p>
                        <Icon name="check" className={styles.checkicon} />
                    </div>
                    <div className={`${styles.item} ${actualSort=='datefrom' ? styles.active : ''}`} onClick={() => changeActualSort("datefrom")} tabIndex={1}>
                        <Icon name="datefrom" className={styles.itemicon}/>
                        <p>Дате создания</p>
                        <Icon name="check" className={styles.checkicon} />
                    </div>
                    <div className={`${styles.item} ${actualSort=='updateto' ? styles.active : ''}`} onClick={() => changeActualSort("updateto")} tabIndex={1}>
                        <Icon name="updateto" className={styles.itemicon}/>
                        <p>Дате обновления</p>
                        <Icon name="check" className={styles.checkicon} />
                    </div>
                    <div className={`${styles.item} ${actualSort=='updatefrom' ? styles.active : ''}`} onClick={() => changeActualSort("updatefrom")} tabIndex={1}>
